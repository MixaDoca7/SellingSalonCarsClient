...
import models.TableModelKomponenta;

/**
 *
 * @author PC
 */
public class FormPretragaKomponente extends javax.swing.JDialog {

    public FormPretragaKomponente(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        TableModelKomponenta model = new TableModelKomponenta();
        Thread th = new Thread(model);
        th.start();
        tblAutomobili.setModel(model);
        setTitle("Pretraga komponenti");
    }
    ...
    private void txtPretragaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPretragaKeyReleased
        ...
        ((TableModelKomponenta) tblAutomobili.getModel()).setParametar(param);
    ...
    private void btnDetaljiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDetaljiActionPerformed
        ...
        if (row >= 0) {
            Komponenta k = ((TableModelKomponenta) tblAutomobili.getModel()).getSelectedKomponenta(row);
            new FormDetaljiKomponenta(this, true, k).setVisible(true);
        }
    ...
    void refreshTable() {
        TableModelKomponenta tm = (TableModelKomponenta) tblAutomobili.getModel();
        tm.refreshTable();
    }
