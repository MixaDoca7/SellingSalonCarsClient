...
public class FormPretragaAutomobila extends javax.swing.JDialog {
    ...
    public FormPretragaAutomobila(java.awt.Frame parent, boolean modal) {
        ...
        TableModelAutomobil model = new TableModelAutomobil();
    ...
    private void txtPretragaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPretragaKeyReleased
        ...
        ((TableModelAutomobil) tblAutomobili.getModel()).setParametar(param);
    ...
    private void btnDetaljiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDetaljiActionPerformed
        ...
        if (row >= 0) {
            Automobil a = ((TableModelAutomobil) tblAutomobili.getModel()).getSelectedAutomobil(row);
